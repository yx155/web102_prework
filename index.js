...
const unfundedString = `A total of $${totalRaised.toLocaleString("en-US")} has been raised for 
    ${GAMES_JSON.length > 1 ? GAMES_JSON.length + " games" : GAMES_JSON.length + " game"}. Currently,
    ${numUnfundedGames} ${numUnfundedGames > 1 ? "games remain" : "game remains"} unfunded. We need your
